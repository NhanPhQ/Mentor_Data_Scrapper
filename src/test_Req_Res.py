...
def md_get_index_components():
  print(
      client.index_components(config, model.index_components('vn100', 1, 100)))
...
def md_get_daily_OHLC():
  print(
      client.daily_ohlc(
          config,
          model.daily_ohlc('ssi', '15/10/2020', '15/10/2020', 1, 100, True)))
...
def md_get_intraday_OHLC():
  print(
      client.intraday_ohlc(
          config,
          model.intraday_ohlc('fpt', '15/10/2020', '15/10/2020', 1, 100, True,
                              1)))
...
def md_get_daily_index():
  print(
      client.daily_index(
          config,
          model.daily_index('123', 'VN100', '15/10/2020', '15/10/2020', 1, 100,
                            '', '')))
...
def md_get_stock_price():
  print(
      client.daily_stock_price(
          config,
          model.daily_stock_price('fpt', '15/10/2020', '15/10/2020', 1, 100,
                                  'hose')))
